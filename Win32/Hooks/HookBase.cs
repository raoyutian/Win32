...
namespace Win32.Hooks
{
   ...
   /// 钩子基类
   /// </summary>
    public abstract class HookBase:IHookBase
    {
        ...
        internal delegate IntPtr HookWndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled);
        #endregion


        #region 变量

        internal  int hwndHook = 0; //钩子句柄  
        internal HookProc HookProcedure; //声明钩子事件类型.  
