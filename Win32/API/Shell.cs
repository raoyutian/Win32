...
namespace Win32
{
	...
	public struct SHFILEINFO
	{
		...
		[MarshalAs(UnmanagedType.ByValArray, SizeConst = 260)] public string szDisplayName;
	...
	public static class Shell
	{
		...
		[DllImport("shell32")] public static extern int DragQueryFile(IntPtr hDROP, int UINT, string lpStr, int ch);
		[DllImport("shell32")] public static extern int DragQueryPoint(IntPtr hDROP, ref POINT lpPoint);
		[DllImport("shell32")] public static extern int DuplicateIcon(IntPtr hInst, IntPtr hIcon);
		[DllImport("shell32")] public static extern int ExtractAssociatedIcon(IntPtr hInst, string lpIconPath, ref int lpiIcon);
		[DllImport("shell32")] public static extern int ExtractIcon(IntPtr hInst, string lpszExeFileName, int nIconIndex);
		...
		[DllImport("shell32")] public static extern int ShellAbout(IntPtr hwnd, string szApp, string szOtherStuff, IntPtr hIcon);
		[DllImport("shell32")] public static extern int ShellExecute(IntPtr hwnd, string lpOperation, string lpFile, string lpParameters, string lpDirectory, int nShowCmd);
		[DllImport("shell32")] public static extern int Shell_NotifyIcon(int dwMessage, ref NOTIFYICONDATA lpData);
		[DllImport("shell32")] public static extern void DragAcceptFiles(IntPtr hwnd, int fAccept);
		[DllImport("shell32")] public static extern void DragFinish(IntPtr hDrop);
		[DllImport("shell32")] public static extern void SHFreeNameMappings(IntPtr hNameMappings);
		[DllImport("shell32")] public static extern void WinExecError(IntPtr hwnd, int error, string lpstrFileName, string lpstrTitle);
